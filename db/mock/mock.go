...
// Source: github.com/devrvk/simplebank/db/sqlc (interfaces: Store)
//
...
import (
	...
	sqlc "github.com/devrvk/simplebank/db/sqlc"
...
func (m *MockStore) TransferTx(ctx context.Context, args sqlc.TransferTxParams) (sqlc.TransferTxResults, error) {
	m.ctrl.T.Helper()
