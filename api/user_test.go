...
// custom matcher which checks the password
// we can use the gmock.eq() matcher but the hashed password will be different due to slating hence the test will fail
